...
def explosion(x, y, size=50):
    ...
    #pygame.mixer.Sound(explosion_sound)
...
def fireShell(xy,tankx,tanky,turPos,gun_power,xlocation,barrier_width,randomHeight,enemyTankX, enemyTankY):
    ...
    while fire:
        ...
        if startingShell[1] > display_height-ground_height:
            ...
            if enemyTankX + 15 > hit_x > enemyTankX - 10:
                print("Critical hit!")
                damage = 25
            elif enemyTankX + 15 > hit_x > enemyTankX - 15:
                print("hard hit!")
                damage = 18
            elif enemyTankX + 15 > hit_x > enemyTankX - 25:
                print("Medium hit!")
                damage = 10
            elif enemyTankX + 15 > hit_x > enemyTankX - 35:
                print("Light hit!")
                damage = 5
   ...
   # pygame.mixer.Sound.play(fire_sound)
    ...
    while fire:
        ...
        if startingShell[1] > display_height-ground_height:
            ...
            if enemyTankX + 15 > hit_x > ptankx - 10:
                print("Critical hit!")
                damage = 25
            elif enemyTankX + 15 > hit_x > ptankx - 15:
                print("hard hit!")
                damage = 18
            elif enemyTankX + 15 > hit_x > ptankx - 25:
                print("Medium hit!")
                damage = 10
            elif enemyTankX + 15 > hit_x > ptankx - 35:
                print("Light hit!")
                damage = 5
            explosion(hit_x,hit_y)
            fire = False
...
def game_over():
    ...
    while game_over:
        ...
        message_to_screen("you dead",black,-30)
...
def you_win():
    ...
    while win:
        ...
        message_to_screen("Saved the princess",black,-30)
